...
4. Viết notebook Jupyter bằng **English** với giải thích chi tiết, trực quan, và ví dụ **Python-first** khi phù hợp.
...
- Toàn bộ nội dung giảng dạy trong notebook phải dùng **English**.
- Toàn bộ nội dung practice notebooks, project brief, và solution notebooks cũng phải dùng **English**.
...
- Project content phải dùng **English** và không dùng icon.
